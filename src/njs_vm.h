...
typedef enum {
    ...
    NJS_OBJ_TYPE_STRING = 4,
    NJS_OBJ_TYPE_FUNCTION = 5,
    NJS_OBJ_TYPE_REGEXP = 6,
    NJS_OBJ_TYPE_DATE = 7,
    NJS_OBJ_TYPE_CRYPTO_HASH = 8,
#define NJS_OBJ_TYPE_HIDDEN_MIN    (8/*NJS_OBJ_TYPE_CRYPTO_HASH*/)
    NJS_OBJ_TYPE_CRYPTO_HMAC = 9,
#define NJS_OBJ_TYPE_HIDDEN_MAX    (9/*NJS_OBJ_TYPE_CRYPTO_HMAC*/ + 1)
    NJS_OBJ_TYPE_ERROR = 10,
    NJS_OBJ_TYPE_EVAL_ERROR = 11,
    NJS_OBJ_TYPE_INTERNAL_ERROR = 12,
    NJS_OBJ_TYPE_RANGE_ERROR = 13,
    NJS_OBJ_TYPE_REF_ERROR = 14,
    NJS_OBJ_TYPE_SYNTAX_ERROR = 15,
    NJS_OBJ_TYPE_TYPE_ERROR = 16,
    NJS_OBJ_TYPE_URI_ERROR = 17,
    NJS_OBJ_TYPE_MEMORY_ERROR = 18,
#define NJS_OBJ_TYPE_MAX      (18/*NJS_OBJ_TYPE_MEMORY_ERROR*/ + 1)
} njs_object_type_t;
